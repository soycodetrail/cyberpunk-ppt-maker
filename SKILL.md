...
```bash
python3 /home/soycodetrail/.codex/skills/cyberpunk-ppt-maker/scripts/generate_cyberpunk_ppt.py \
...
```bash
python3 /home/soycodetrail/.codex/skills/cyberpunk-ppt-maker/scripts/export_cyberpunk_images.py \
  --spec ./cyberpunk-spec.json \
...
```bash
python3 /home/soycodetrail/.codex/skills/cyberpunk-ppt-maker/scripts/markdown_to_cyberpunk_spec.py \
...
```bash
python3 /home/soycodetrail/.codex/skills/cyberpunk-ppt-maker/scripts/clone_reference_cyberpunk_style.py \
